...
export function AnimatedTetrahedron({ color = "white" }: AnimatedTetrahedronProps) {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      points.forEach((point) => {
        const alpha = 0.3 + (point.z + 1.5) * 0.35;
        const [r, g, b] = color === "accent" ? [255, 124, 72] : [255, 255, 255];
